...
const StatCell = ({ label, value }) => (
  <div className="flex flex-col bg-gray-900/80 rounded-lg py-2 px-3 border border-gray-700/50 transition-colors hover:border-purple-500/50">
    ...
    <span className="text-gray-100 font-bold text-base leading-tight">
      {value}
    </span>
  </div>
);
            ...
            <div className="flex-1 min-w-0 w-full">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {character.alignment && (
                  <Badge
                    variant="outline"
                    className="text-[10px] py-0 px-1.5 border-gray-600 text-gray-500 font-normal uppercase tracking-tighter"
                  >
                    {character.alignment}
                  </Badge>
                )}
              ...
              <div className="mt-2 flex items-center gap-2">
                <div className="h-1 flex-1 bg-gray-950 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(100, (character.experience / 355000) * 100)}%`,
                    }}
                  ></div>
                </div>
        ...
        <CardContent className="p-5 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-xs text-yellow-300/80 font-black uppercase tracking-widest">
                Atributos
              </p>
            </div>
          ...
          {/* Coins */}
          <div className="pt-2">
            <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mb-3 text-center border-b border-gray-700/50 pb-2">
