    ...
    >
      <CardContent className="p-4 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex-1 w-full">
          ...
          {(char.char_class || char.race) && (
            <p className="text-sm text-gray-400 mt-1">
              {char.char_class}
              {char.secondary_class ? ` / ${char.secondary_class}` : ''}
              {char.char_class && char.race && (
        ...
        <div className="bg-gray-900 px-4 py-2 rounded-lg border border-gray-700/50 text-center min-w-[4rem] shrink-0">
          ...
          <span className="block text-xl font-bold text-gray-100 leading-none">
            {char.level}
          </span>
        </div>
      </CardContent>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-10 text-center">
        ...
        <p className="text-gray-400 max-w-2xl mx-auto">
          Explora los héroes y entidades de este mundo.
        </p>
      </div>
        ...
        <div>
          ...
          {mainCharacters.length === 0 ? (
            <p className="text-gray-500 text-sm italic text-center py-8">
              No hay héroes públicos actualmente.
            </p>
          ) : (
